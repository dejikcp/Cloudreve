...
release() {
  ...
  SUPPORTED_OSARCH="linux/amd64/gcc linux/s390x/s390x-linux-gnu-gcc linux/arm/arm-linux-gnueabihf-gcc windows/amd64/x86_64-w64-mingw32-gcc linux/arm64/aarch64-linux-gnu-gcc"
